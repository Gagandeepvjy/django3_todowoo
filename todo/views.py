    ...
    if request.method=="GET":
        ...
        if(request.POST['password1'] == request.POST['password2']):
           try:
               ...
               return render(request,'todo/signupuser.html',{'form':UserCreationForm(),'error':"That username already taken"})
        else:
           #Tell passwords dont match
...
def viewtodo(request,todo_pk):
    ...
    if request.method=="GET":
        ...
        try:
            ...
            return render(request,'todo/viewtodo.html',{'form':todo,'error':'Bad Data passed in'})
@login_required
